      ...
      <div className="footer__inner">
        <div className="footer__grid">
          ...
          <div className="footer__brand">
            <div className="footer__brand-logo">
              <div className="footer__brand-icon">E</div>
              <span className="footer__brand-name">Edu<span>Verse</span></span>
            </div>
        ...
        <div className="footer__bottom">
          <p className="footer__copy">
            © {new Date().getFullYear()} EduVerse. All rights reserved. Made with ❤️ in Vietnam.
          </p>
