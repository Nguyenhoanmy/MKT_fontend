...
export const metadata: Metadata = {
  title: { default: 'EduVerse — Nền tảng học trực tuyến hàng đầu Việt Nam', template: '%s | EduVerse' },
  ...
  openGraph: {
    type: 'website',
    locale: 'vi_VN',
    url: 'https://eduverse.vn',
    siteName: 'EduVerse',
    title: 'EduVerse — Nền tảng học trực tuyến hàng đầu Việt Nam',
