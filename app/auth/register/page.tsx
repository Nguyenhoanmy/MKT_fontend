      ...
      <div className="auth-page__visual">
        <div className="auth-page__visual-content">
          ...
          <p className="auth-page__visual-desc">
            Tham gia cùng 50,000+ học viên đang học tập và phát triển sự nghiệp với EduVerse.
          </p>
      ...
      <div className="auth-page__form-wrap">
        <div className="auth-page__form">
          <div className="auth-page__form-logo">
            <div className="auth-page__form-logo-icon">E</div>
            <span className="auth-page__form-logo-text">Edu<span>Verse</span></span>
          </div>
