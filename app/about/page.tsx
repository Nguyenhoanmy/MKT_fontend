        ...
        <div className="container">
          ...
          >
            ...
            <p className="about-page__hero-subtitle">
              MKT không chỉ là nền tảng học tập, chúng tôi là bệ phóng giúp hàng ngàn bạn trẻ tại Việt Nam chinh phục những nấc thang cao nhất trong ngành Công nghệ thông tin.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <p style={{ color: '#6B7280', fontSize: 18, maxWidth: 600, margin: '0 auto' }}>
              Những nguyên tắc dẫn lối mọi hoạt động và quyết định của đội ngũ MKT.
            </p>
          </div>
